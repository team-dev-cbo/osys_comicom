...
<html>
    ...
    <body>
        <div id="div_dts" style="border:solid #3877AA 1px; height:100%;">
            <iframe id="dts" style="width:100%; height:100%;">
            </iframe>
        </div>
                    ...
                    <td width="100%" align="center" valign="middle">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <font style="color: #6699CC; font-size:14px"><%= rb.getString("dts.loading")%></font>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <div id="toolbar" class="toolbarContainer toolbarStatique" align="center">
            <img src="../images/back.png" onclick="history.back()" style="position:relative;" title="<%= rb.getString("supervisor.dts_view.back")%>"/>
        </div>
        ...
        <script type="text/javascript">
            ...
            var div_dts = document.getElementById('div_dts');
            div_dts.style.width = document.body.clientWidth - 50;
            div_dts.style.display = 'none';
